<div>
    <div class="content-wrapper">
                            ...
                            <tbody>
                                @foreach ($visits as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->waktu_kunjungan->format('d M Y H:i') }}</td>
        ...
        {{-- Create Modal --}}
        @include('livewire.admin.kunjungan.create')
        {{-- Create Modal --}}
        ...
        {{-- Edit Modal --}}
        @include('livewire.admin.kunjungan.edit')
        {{-- Edit Modal --}}
        ...
        {{-- Delete Modal --}}
        @include('livewire.admin.kunjungan.delete')
        {{-- Delete Modal --}}
