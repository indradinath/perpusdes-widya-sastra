      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                @elseif($old_gambar_sampul)
                    <div class="mt-2">
                        <p>Gambar Sampul Saat Ini:</p>
                        <img src="{{ asset('storage/' . $old_gambar_sampul) }}" style="max-width: 150px; height: auto;">
                    </div>
                @endif
            </div>
        ...
        <div class="modal-footer">
            ...
            <button wire:click="update({{ $book_id }})" type="button" class="btn btn-warning btn-sm">
                <i class="fas fa-edit mr-1"></i>
                Update
            </button>
        </div>
